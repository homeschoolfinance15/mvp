...
const file = process.argv[2] === '--host-permissions'
  ? 'supabase/migrations/20260925100601_event_host_permissions.sql'
  : 'supabase/migrations/20260925100301_uat_feedback_and_updates.sql'
